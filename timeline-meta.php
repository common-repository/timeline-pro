...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td style="vertical-align:middle;">
		<textarea cols="30" rows="1" style="background:#bfefff" onClick="this.select();">[timeline_pro <?php echo 'id="'.$post->ID.'"';?>]</textarea>
        <br />
		<span style=" color:#22aa5d;font-size: 12px;">Copy this shortcode and paste on page or post where you want to display Timeline.</span>
		<br />
		<br />
        PHP Code:<br />
		<textarea cols="54" rows="1" style="background:#bfefff" onClick="this.select();"><?php echo '<?php echo do_shortcode("[timeline_pro id='; echo "'".$post->ID."']"; echo '");?>';?></textarea>        
		<br />
		<span style=" color:#22aa5d;font-size: 12px;">Use this PHP code to your themes file to display Timeline</span>
		</td>
	</tr>
	<tr valign="top">
		<th scope="row"><br />Need Help ?</th>
		<td style="vertical-align:middle;"><br />Please report any issue via our support forum <a target="_blank" href="http://pluginspoint.com/">Help & Support</a>
		</td>
	</tr>
